...
OCEAN TRICO(オーシャントリコ)_その他	y = 77.1095 * ln(x) + -656.0219	0.61	150	195023	y = 0.0013 * x + 54.4297	0.6003679456
OCEAN TRICO(オーシャントリコ)_スプレー	y = 365.3877 * ln(x) + -3853.9650	0.81	2198	833174	y = 0.0015 * x + 178.5103	0.8266700502
OCEAN TRICO(オーシャントリコ)_ワックス	y = 1051.4716 * ln(x) + -12066.0985	0.82	525	2850648	y = 0.0003 * x + 1977.5350	0.7597652392"""
